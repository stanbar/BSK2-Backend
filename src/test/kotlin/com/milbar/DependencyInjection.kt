...
import com.milbar.DatabaseTag.DB_PATH_TEST
...
object DatabaseTag{
    const val DB_PATH_TEST = "dbPathTest"

}
val dbModule = Kodein.Module {
    constant(DB_PATH_TEST) with "jdbc:sqlite:database_test.db"

    bind<JdbcConnectionSource>() with provider { JdbcConnectionSource(instance(DB_PATH_TEST)) }
}
